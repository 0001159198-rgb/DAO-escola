public class Professor {
    ...
    public Professor(String nome, String email,String estado,String cidade,String estado_civil,String materia_responsavel) {
        this.nome = nome;
        this.email = email;
        this.estado = estado;
        this.cidade = cidade;
    ...
    public Professor(int id, String nome, String email, String estado, String cidade, String estado_civil, String materia_responsavel) {
        this.id = id;
        this.nome = nome;
        this.email = email;
        this.estado = estado;
